...
return [
    ...
    */
    ...
    |
    */
    'entity' => Railken\LaraOre\Vocabulary\Vocabulary::class,
    ...
    |
    */
    'manager' => Railken\LaraOre\Vocabulary\VocabularyManager::class,
    ...
    |
    */
    'repository' => Railken\LaraOre\Vocabulary\VocabularyRepository::class,
    ...
    |
    */
    'serializer' => Railken\LaraOre\Vocabulary\VocabularySerializer::class,
    ...
    |
    */
    'validator' => Railken\LaraOre\Vocabulary\VocabularyValidator::class,
    ...
    |
    */
    'authorizer' => Railken\LaraOre\Vocabulary\VocabularyAuthorizer::class,
    ...
    */
    'http' => [
        'admin' => [
            'enabled'    => true,
            'controller' => Railken\LaraOre\Http\Controllers\Admin\VocabulariesController::class,
            'router'     => [
                'prefix'      => '/vocabularies',
            ],
        ],
