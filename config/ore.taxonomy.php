...
return [
    ...
    */
    ...
    |
    */
    'entity' => Railken\LaraOre\Taxonomy\Taxonomy::class,
    ...
    |
    */
    'manager' => Railken\LaraOre\Taxonomy\TaxonomyManager::class,
    ...
    |
    */
    'repository' => Railken\LaraOre\Taxonomy\TaxonomyRepository::class,
    ...
    |
    */
    'serializer' => Railken\LaraOre\Taxonomy\TaxonomySerializer::class,
    ...
    |
    */
    'validator' => Railken\LaraOre\Taxonomy\TaxonomyValidator::class,
    ...
    |
    */
    'authorizer' => Railken\LaraOre\Taxonomy\TaxonomyAuthorizer::class,
